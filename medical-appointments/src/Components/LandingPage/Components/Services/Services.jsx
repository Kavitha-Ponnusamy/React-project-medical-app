...
const demoData = [
  {
    imageSrc:
      "https://img.freepik.com/free-vector/online-doctor-consultation-illustration_88138-414.jpg?size=626&ext=jpg",
  ...
  {
    imageSrc:
      "https://img.freepik.com/free-vector/doctor-examining-patient-clinic-illustrated_23-2148856559.jpg?size=626&ext=jpg",
    title: "Find a doctor",
  },
  {
    imageSrc:
      "https://img.freepik.com/free-vector/hospital-service-concept-flat-illustration_1150-50287.jpg?size=626&ext=jpg",
  ...
  return (
    <div>
      <section className="services" id="services">
        <div className="section__container services__container">
